  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="bg-white rounded-2xl shadow-xl border border-gray-100 p-10 w-full max-w-sm text-center">
        ...
        <p className="text-gray-500 text-sm mb-8">Sign in to access your personal command center</p>
        ...
        <p className="text-xs text-gray-400 mt-6">
          Google Tasks sync included — due-dated work syncs to your Google Tasks list.
        </p>
      </div>
    </div>
  );
